 ...
 *
 * <p>
 * Every CodeModel node is always owned by one {@link com.sun.codemodel.JCodeModel} object
 ...
 * in a top-down fashion. For example, you create a class from {@link com.sun.codemodel.JCodeModel},
 * which gives you a {@link com.sun.codemodel.JDefinedClass}. Then you invoke a method on it
 * to generate a new method, which gives you {@link com.sun.codemodel.JMethod}, and so on.
 *
 ...
 * <p>
 * Most of the time you'd want to populate new type definitions in a {@link com.sun.codemodel.JCodeModel}.
 * See {@link #_class(String, com.sun.codemodel.ClassType)}.
 */
public final class JCodeModel {
    ...
    /**
     * Creates a dummy, unknown {@link com.sun.codemodel.JClass} that represents a given name.
     *
     * <p>
     ...
     * @see com.sun.codemodel.JPackage#_getClass(String)
     */
     ...
     *      Use {@link #anonymousClass(com.sun.codemodel.JClass)} instead.
     */
    ...
    /**
     * Generates Java source code.
     * A convenience method that calls {@link #build(com.sun.codemodel.CodeWriter, com.sun.codemodel.CodeWriter)}.
     *
     * @param	srcDir
     ...
     * {@link Object}, and return a {@link com.sun.codemodel.JClass}.
     */
    ...
    /**
     * Gets a {@link com.sun.codemodel.JClass} representation for "?",
