...
public abstract class JClass extends JType
{
     ...
     *      entity (class or interface) represented by this {@link com.sun.codemodel.JClass}.
     *      Even if no super class is given explicitly or this {@link com.sun.codemodel.JClass}
     *      is not a class, this method still returns
     *      {@link com.sun.codemodel.JClass} for {@link Object}.
     ...
     *		{@link com.sun.codemodel.JClass} objects that represents those interfaces
     ...
     * 
     * <p>
     * For example, if this {@link com.sun.codemodel.JClass} represents
    ...
    /**
     * @deprecated calling this method from {@link com.sun.codemodel.JClass}
     ...
     * (where V then doing
     * substituteParams( V, Integer ) returns a {@link com.sun.codemodel.JClass}
