 ...
 * in this class. A value can be a {@link com.sun.codemodel.JType} (which will be prinited with a @link tag),
...
public class JCommentPart extends ArrayList<Object> {
     ...
     * Appends a new value.
     *
     * If the value is {@link com.sun.codemodel.JType} it will be printed as a @link tag.
