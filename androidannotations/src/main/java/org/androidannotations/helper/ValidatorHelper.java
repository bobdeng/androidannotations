...
public class ValidatorHelper {
    ...
    public void enclosingElementHasEBeanOrEViewHolder(Element element, AnnotationElements validatedElements, IsValid valid) {
        Element enclosingElement = element.getEnclosingElement();
        @SuppressWarnings("unchecked")
        List<Class<? extends Annotation>> validAnnotations = asList(EBean.class, EViewHolder.class);
