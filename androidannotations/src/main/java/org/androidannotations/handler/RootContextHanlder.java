...
public class RootContextHanlder extends BaseAnnotationHandler<EComponentWithViewSupportHolder> {
	...
	public void validate(Element element, AnnotationElements validatedElements, IsValid valid) {
		validatorHelper.enclosingElementHasEBeanOrEViewHolder(element, validatedElements, valid);
