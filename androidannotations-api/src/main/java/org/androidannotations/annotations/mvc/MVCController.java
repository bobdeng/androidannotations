...
public class MVCController {
    ...
    private MVCController(Context context) {
        ...
        Log.d(TAG,String.format("MVC Thread count: %d",threadCount));
    ...
    public void doAction(final Context context, final Intent intent) {
        ...
        Log.d(TAG,String.format("Action start: %s.%s",actionClass.getCanonicalName(),intent
        ...
        if (actionClass != null) {
            ...
            currentExecutor.execute(new PriorityTask(intent.getIntExtra(
                ...
                public void run() {
                    ...
                    Log.d(TAG,String.format("Action end: %s.%s",actionClass.getCanonicalName(),intent
                            .getStringExtra(CyclopsConstants.EXTRA_METHOD)));
                }
            });
        }
